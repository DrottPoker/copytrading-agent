...
BACKUP_INTERVAL_SECONDS="${BACKUP_INTERVAL_SECONDS:?BACKUP_INTERVAL_SECONDS must be configured}"
BACKUP_RETENTION_DAYS="${BACKUP_RETENTION_DAYS:?BACKUP_RETENTION_DAYS must be configured}"
